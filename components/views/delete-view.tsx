...
import { Trash2, AlertTriangle, CheckCircle, AlertCircle, ArrowLeft, TreePine, Home } from "lucide-react"
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-foreground mb-2">Eliminar Animal</h1>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-lg">{new Date(animal.birthDateTime).toLocaleString()}</p>
            </div>
            <div>
          ...
          {!showConfirmation ? (
            ...
            <div className="space-y-4 mt-4">
              <Alert className="border-destructive">
                ...
                <AlertDescription>
                  <strong>¿Estás seguro?</strong> Esta acción no se puede deshacer. El animal "{animal.name}" será
