...
const habitatMenuItems = [
  ...
  {
    id: "habitat-detail" as ViewType,
    label: "Detalle con Animales",
    icon: Eye,
  },
  {
    id: "habitats-with-animals" as ViewType,
    label: "Vista Completa",
    icon: Globe,
  },
  {
    id: "search-edit-habitat" as ViewType,
    label: "Buscar para Editar",
    icon: Edit,
  },
  {
    id: "search-delete-habitat" as ViewType,
    label: "Buscar para Eliminar",
    icon: Trash2,
  },
];
